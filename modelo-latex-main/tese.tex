...
\title{A Comparison of Embedding Models in Semantic Similarity Tasks for Software Engineering}
\translatedtitle{Uma comparação de modelos de embedding em tarefas de similaridade semântica para Engenharia de Software}

\author[masc]{Vinícius Henrique Ferraz Lima}

\def\profa{Prof\kern.02em.\kern-.07emª\kern.07em}
\def\dra{Dr\kern-.04em.\kern-.11emª\kern.07em}

% English aliases for advisor commands
\let\Advisor\orientador
\let\Coadvisor\coorientador

% Para TCCs, este comando define o supervisor
\Advisor{Arthur Pilone Maia da Silva}

% Se não houver, remova; se houver mais de um, basta
% repetir o comando quantas vezes forem necessárias
\Coadvisor{Prof. Paulo Roberto Miranda Meirelles}
...
\epigrafe{Audentes Fortuna Iuvat!}{Hans Capon}
...
\pagestyle{mainmatter}
\input{conteudo/01-conteudos-relacionados}
\input{conteudo/02-dados-e-metodos}
\input{conteudo/05-resultados}
